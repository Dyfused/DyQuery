...
_✨ A nonebot2 plugin for getting the latest play record for Dynamite Explode, working well on Onebot V11 and Discord. ✨_
...
```
API_BASE_URL="http://<服务器地址>/bomb/v2/"
USER_SEARCH_API="user/search"
USER_BASE_API="user/"
BG_DOWNLOAD_URL_BASE="http://<服务器地址>/download/cover/480x270_jpg/"
```
